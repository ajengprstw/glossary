...
Tidak jauh berbeda dengan R Squared, yaitu persentase variansi target variabel yang dijelaskan oleh model, perbedaannya adalah Adjusted R squared memmperhitungkan banyak observasi dan prediktor yang digunakan.
...
Stepwise adalah algoritma yang bertahap menambahkan atau mengurangkan variabel dengan mengacu pada nilai AIC terkecil.
...
Klasifikasi adalah metode machine learning yang digunakan untuk memprediksi target dengan nilai kategorik.
...
Null deviance menunjukkan seberapa baik target variabel diprediksi oleh model berdasarkan nilai intercept.

- ***Residual Deviance***

Residual deviance menunjukkan seberapa baik target variabel diprediksi oleh model berdasarkan intercept dan semua variabel independen yang digunakan.

- ***Maximum Likelihood Estimator***

Maximum Likelihood Estimator merupakan pendekatan statistik untuk memperkirakan paramater pada model.

# Classification 2

- ***Probability***

  Besar kemungkinan suatu kejadian. 
...
- ***Laplace estimator***
  ...
  Menambahkan nilai yang sangat kecil, biasanya adalah 1 pada masing-masing jumlah kejadian.
